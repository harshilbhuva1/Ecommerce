...
const CategoryProduct = () => {
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      {/* Mobile Filters */}
      {showMobileFilter && (
        <div className="bg-white p-4 mb-4 rounded shadow-md lg:hidden">
          {/* Sort by */}
          <div>
            <h3 className="text-base font-medium text-slate-500 border-b pb-1">Sort by</h3>
            <form className="text-sm flex flex-col gap-2 py-2">
          ...
          {/* Category Filter */}
          <div className="mt-4">
            <h3 className="text-base font-medium text-slate-500 border-b pb-1">Category</h3>
            <form className="text-sm flex flex-col gap-2 py-2">
      ...
      <div className="hidden lg:grid grid-cols-[200px_1fr] gap-4">
        ...
        {/* Product Section */}
        <div>
          <p className="font-medium text-slate-800 text-lg mb-3">Search Results: {data.length}</p>
